...
def add_resource():
    try:
        ...
        if not title or not skills or not file:
        ...
        cursor.execute("""
            INSERT INTO resources (title, description, skills, file_path, file_type, uploaded_by)
            VALUES (%s, %s, %s, %s, %s, %s)
        """, (title, description, skills, filepath, file_type, uploaded_by))
